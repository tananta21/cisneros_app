...
@section('menu_modulos')
    ...
    <h3 class="col-lg-12" style="margin-bottom: 0.5rem">Gestor Tipo Productos</h3>
    ...
    <div class="col-lg-5">
        <a  data-toggle="modal" data-target="#crear_tipoproducto_modal" href="#" style="font-size: 1.6rem">
            <i class="fa fa-plus-circle fa-2x" aria-hidden="true"></i> <span style="color: #000000">Agregar Nuevo Tipo Producto</span>
        </a>
    </div>
