...
@section('menu_modulos')
    ...
    <h3 class="col-lg-12" style="margin-bottom: 0.5rem">Lista Tipo Movimiento</h3>
    ...
    <div class="col-lg-4" style="text-align: center; margin-top: 10rem">
        <button data-toggle="modal" data-target="#crear_tipoproducto_modal" class="btn btn-primary">Agregar Nuevo Tipo Movimiento</button>
    </div>
