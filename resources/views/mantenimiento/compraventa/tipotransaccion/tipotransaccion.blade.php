...
@section('menu_modulos')
    ...
    <h3 class="col-lg-12" style="margin-bottom: 0.5rem">Lista Tipo Transaccion</h3>
    <hr class="col-lg-12 linea-titulo" size="5px" color="green"/>
    <div class="col-lg-12">
        <a href="/mantenimiento/tipotransaccion" class="btn btn-primary btn-md col-lg-1" >Recargar <i class="fa fa-refresh fa-1x"></i></a>

        {!! Form::model(Request::all(),['route'=>'buscar.tipotransaccion','method' => 'get', 'class' => 'form-horizontal', 'role'=>'form']) !!}
        {{--<div class="col-lg-3">--}}
        ...
        function eliminarCategoria(id){
            if (confirm('¿Estas seguro que desea desactivar Marca ?')) {
                $(document).ready(function(){
                    ...
                    var url = '{{route("eliminar.tipotransaccion")}}';
                    $.ajax({
                        type: 'GET',
                        url: url,
                        data: {
    ...
    <script type="text/javascript">
        function editarCategoria(id){
            $(document).ready(function(){
                ...
                var url = '{{route("editar.tipotransaccion")}}';
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Registrar Tipo Transaccion</h4>
                </div>
                <div class="modal-body">
                    {{--formulario crear --}}
                    <div class="box box-primary">
                        {!! Form::open(['action' => 'MantenimientoCompraVentaController@crearTipoTransaccion','method' => 'post', 'class' => 'form-horizontal', 'role'=>'form']) !!}
                        <div class="box-body">
    ...
    <div class="modal fade " id="editar_tipoproducto_modal" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="gridModalLabel" aria-hidden="true">>
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Editar Tipo Transaccion</h4>
                </div>
                <div class="modal-body">
                    {{--formulario editar --}}
                    <div class="box box-primary">
                        {!! Form::open(['action' => 'MantenimientoCompraVentaController@actualizarTipoTransaccion','method' => 'post', 'class' => 'form-horizontal', 'role'=>'form']) !!}
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputName" class="col-md-2 control-label">Marca</label>
                                <div class="col-md-6">
                                    <input type="hidden" id="marcaid" name="marca_id" value=""/>
                                    <input id="descripmarca" onkeypress="return soloLetras(event)" required="true" maxlength="30" type="text" class="form-control"  placeholder="Nombre Tipo Pago" name="descripcion_marca" >
                                    <span style="font-size: 1rem; color: #0000ff">Maximo 30 caracteres</span>
                                </div>
                                <div class="col-md-4">
