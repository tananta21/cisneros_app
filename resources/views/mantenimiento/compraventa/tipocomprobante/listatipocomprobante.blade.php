...
@section('menu_modulos')
    ...
    <h3 class="col-lg-12" style="margin-bottom: 0.5rem">Lista Tipo Comprobante</h3>
        ...
        function eliminarCategoria(id){
            if (confirm('¿Estas seguro que desea desactivar Marca ?')) {
                $(document).ready(function(){
                    ...
                    var url = '{{route("eliminar.tipocomprobante")}}';
                    $.ajax({
                        type: 'GET',
                        url: url,
                        data: {
    ...
    <script type="text/javascript">
        function editarCategoria(id){
            $(document).ready(function(){
                ...
                var url = '{{route("editar.tipocomprobante")}}';
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="box box-primary">
                        {!! Form::open(['action' => 'MantenimientoCompraVentaController@crearTipoComprobante','method' => 'post', 'class' => 'form-horizontal', 'role'=>'form']) !!}
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputName" class="col-md-2 control-label">Tipo</label>
                                <div class="col-md-6">
                                    <input id="texto_descripcion" onkeypress="return soloLetras(event)" required="true" maxlength="30" type="text" class="form-control"  placeholder="Nombre Comprobante" name="descripcion_tipo" >
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{--formulario editar --}}
                    <div class="box box-primary">
                        {!! Form::open(['action' => 'MantenimientoCompraVentaController@actualizarTipoComprobante','method' => 'post', 'class' => 'form-horizontal', 'role'=>'form']) !!}
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputName" class="col-md-2 control-label">Marca</label>
                                <div class="col-md-6">
                                    <input type="hidden" id="marcaid" name="marca_id" value=""/>
                                    <input id="descripmarca" onkeypress="return soloLetras(event)" required="true" maxlength="30" type="text" class="form-control"  placeholder="Nombre Comprobante" name="descripcion_marca" >
                                    <span style="font-size: 1rem; color: #0000ff">Maximo 30 caracteres</span>
                                </div>
                                <div class="col-md-4">
