...
@section('menu_modulos')
    ...
    <h3 class="col-lg-12" style="margin-bottom: 0.5rem">Lista Tipo Pago</h3>
    <hr class="col-lg-12 linea-titulo" size="5px" color="green"/>
    <div class="col-lg-12">
        <a href="/mantenimiento/tipopago" class="btn btn-primary btn-md col-lg-1" >Recargar <i class="fa fa-refresh fa-1x"></i></a>

        {!! Form::model(Request::all(),['route'=>'buscar.tipopago','method' => 'get', 'class' => 'form-horizontal', 'role'=>'form']) !!}
        {{--<div class="col-lg-3">--}}
        ...
        function eliminarCategoria(id){
            if (confirm('¿Estas seguro que desea desactivar......... '+$('#texto'+id).text()+'?')) {
                $(document).ready(function(){
                    ...
                    var url = '{{route("eliminar.tipopago")}}';
                    $.ajax({
                        type: 'GET',
                        url: url,
                        data: {
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="box box-primary">
                        {!! Form::open(['action' => 'MantenimientoCompraVentaController@crearTipoPago','method' => 'post', 'class' => 'form-horizontal', 'role'=>'form']) !!}
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputName" class="col-md-2 control-label">Tipo</label>
                                <div class="col-md-6">
                                    <input id="texto_descripcion" onkeypress="return soloLetras(event)" required="true" maxlength="30" type="text" class="form-control"  placeholder="Nombre Tipo Pago" name="descripcion_tipo" >
