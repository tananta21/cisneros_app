                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input  required="true" maxlength="30" type="text" class="form-control"  placeholder="Nombre Grado Instruccion" name="descripcion_tipo" >
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="descripmarca" required="true" maxlength="30" type="text" class="form-control"  placeholder="Grado Instruccion" name="descripcion_marca" >
                                    <span style="font-size: 1rem; color: #0000ff">Maximo 30 caracteres</span>
                                </div>
                                <div class="col-md-4">
