...
@section('menu_modulos')
    ...
    <h3 class="col-lg-12" style="margin-bottom: 0.5rem">Lista Grado Instruccion</h3>
    ...
    <div class="col-lg-5">
        <a data-toggle="modal" data-target="#crear_tipoproducto_modal" href="#" style="font-size: 1.6rem">
            <i class="fa fa-plus-circle fa-2x" aria-hidden="true"></i> <span style="color: #000000">Agregar Grado de Instruccion</span>
        </a>
    </div>
    ...
    {{--<div class="col-lg-4" style="text-align: center; margin-top: 10rem">--}}
        {{--<button data-toggle="modal" data-target="#crear_tipoproducto_modal" class="btn btn-primary">Agregar Nuevo Grado Instruccion</button>--}}
    {{--</div>--}}
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Registrar Grado Instruccion</h4>
                </div>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="texto_descripcion" onkeypress="return soloLetras(event)"  required="true" maxlength="30" type="text" class="form-control"  placeholder="Nombre Grado Instruccion" name="descripcion_tipo" >
    ...
    <div class="modal fade " id="editar_estadocivil_modal" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="gridModalLabel" aria-hidden="true">>
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Editar Grado Instruccion</h4>
                </div>
                <div class="modal-body">
                    {{--formulario editar --}}
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="descripmarca" onkeypress="return soloLetras(event)" required="true" maxlength="30" type="text" class="form-control"  placeholder="Grado Instruccion" name="descripcion_marca" >
                                    <span style="font-size: 1rem; color: #0000ff">Maximo 30 caracteres</span>
                                </div>
                                <div class="col-md-4">
