...
@section('menu_modulos')
    ...
    <h3 class="col-lg-12" style="margin-bottom: 0.5rem">Lista Tipo Empleado</h3>
    <hr class="col-lg-12 linea-titulo" size="5px" color="green"/>

    <div class="col-lg-7">
        {!! Form::model(Request::all(),['route'=>'buscar.tipoempleado','method' => 'get', 'class' => 'form-horizontal', 'role'=>'form']) !!}
        <div class="col-lg-2">
    ...
    <div class="col-lg-5">
        <a data-toggle="modal" data-target="#crear_tipoproducto_modal" href="#" style="font-size: 1.6rem">
            <i class="fa fa-plus-circle fa-2x" aria-hidden="true"></i> <span style="color: #000000">Agregar Tipo Empleado</span>
        </a>
    </div>
    {{--<div class="col-lg-12">--}}
        {{--<a href="/mantenimiento/tipoempleado" class="btn btn-primary btn-md col-lg-1" >Recargar <i class="fa fa-refresh fa-1x"></i></a>--}}
    ...
    <script type="text/javascript">
        function editarCategoria(id){
            $(document).ready(function(){
                ...
                var url = '{{route("editar.tipoempleado")}}';
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="box box-primary">
                        {!! Form::open(['action' => 'MantenimientoEmpleadoController@crearTipoEmpleado','method' => 'post', 'class' => 'form-horizontal', 'role'=>'form']) !!}
                        <div class="box-body">
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{--formulario editar --}}
                    <div class="box box-primary">
                        {!! Form::open(['action' => 'MantenimientoEmpleadoController@actualizarTipoEmpleado','method' => 'post', 'class' => 'form-horizontal', 'role'=>'form']) !!}
                        <div class="box-body">
                            <div class="form-group">
