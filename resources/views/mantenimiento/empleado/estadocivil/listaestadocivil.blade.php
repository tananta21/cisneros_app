...
@section('menu_modulos')
    ...
    {{--<div class="col-lg-12">--}}
        {{--<a href="/mantenimiento/estadocivil" class="btn btn-primary btn-md col-lg-1" >Recargar <i class="fa fa-refresh fa-1x"></i></a>--}}

        {{--{!! Form::model(Request::all(),['route'=>'buscar.estadocivil','method' => 'get', 'class' => 'form-horizontal', 'role'=>'form']) !!}--}}
        {{--<div class="col-lg-3">--}}
    ...
    <div class="col-lg-5">
        <a data-toggle="modal" data-target="#crear_tipoproducto_modal"href="#" style="font-size: 1.6rem">
            <i class="fa fa-plus-circle fa-2x" aria-hidden="true"></i> <span style="color: #000000">Agregar Estado Civil</span>
        </a>
    </div>
        ...
        function eliminarCategoria(id){
            if (confirm('¿Estas seguro que desea desactivar Marca ?')) {
                $(document).ready(function(){
                    ...
                    var url = '{{route("eliminar.estadocivil")}}';
                    $.ajax({
                        type: 'GET',
                        url: url,
                        data: {
    ...
    <script type="text/javascript">
        function editarCategoria(id){
            $(document).ready(function(){
                ...
                var url = '{{route("editar.estadocivil")}}';
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="box box-primary">
                        {!! Form::open(['action' => 'MantenimientoEmpleadoController@crearEstadoCivil','method' => 'post', 'class' => 'form-horizontal', 'role'=>'form']) !!}
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputName" class="col-md-2 control-label">Tipo</label>
                                <div class="col-md-6">
                                    <input id="texto_descripcion" onkeypress="return soloLetras(event)"   required="true" maxlength="30" type="text" class="form-control"  placeholder="Nombre Tipo Estado Civil" name="descripcion_tipo" >
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="descripmarca" onkeypress="return soloLetras(event)" required="true" maxlength="30" type="text" class="form-control"  placeholder="Nombre Tipo Estado Civil" name="descripcion_marca" >
                                    <span style="font-size: 1rem; color: #0000ff">Maximo 30 caracteres</span>
                                </div>
                                <div class="col-md-4">
