        ...
        function eliminarCategoria(id){
            if (confirm('¿Estas seguro que desea desactivar Marca ?')) {
                $(document).ready(function(){
                    ...
                    var url = '{{route("eliminar.tipocliente")}}';
                    $.ajax({
                        type: 'GET',
                        url: url,
                        data: {
    ...
    <script type="text/javascript">
        function editarCategoria(id){
            $(document).ready(function(){
                ...
                var url = '{{route("editar.tipocliente")}}';
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Registrar Tipo Cliente</h4>
                </div>
                <div class="modal-body">
                    {{--formulario crear --}}
                    <div class="box box-primary">
                        {!! Form::open(['action' => 'MantenimientoEmpleadoController@crearTipoCliente','method' => 'post', 'class' => 'form-horizontal', 'role'=>'form']) !!}
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputName" class="col-md-2 control-label">Tipo</label>
                                <div class="col-md-6">
                                    <input  required="true" maxlength="30" type="text" class="form-control"  placeholder="Nombre Tipo Cliente" name="descripcion_tipo" >
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{--formulario editar --}}
                    <div class="box box-primary">
                        {!! Form::open(['action' => 'MantenimientoEmpleadoController@actualizarTipoCliente','method' => 'post', 'class' => 'form-horizontal', 'role'=>'form']) !!}
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputName" class="col-md-2 control-label">Tipo</label>
                                <div class="col-md-6">
                                    <input type="hidden" id="marcaid" name="marca_id" value=""/>
                                    <input id="descripmarca" required="true" maxlength="30" type="text" class="form-control"  placeholder="Nombre Tipo" name="descripcion_marca" >
                                    <span style="font-size: 1rem; color: #0000ff">Maximo 30 caracteres</span>
                                </div>
                                <div class="col-md-4">
